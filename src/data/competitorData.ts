...
export const competitors: Competitor[] = [
  ...
  },
  {
    ...
    studentMessaging: 'The apps that power creative careers. Students save 71% on Creative Cloud All Apps — Photoshop, Premiere Pro, Illustrator, and 20+ more. Master the tools that employers expect.',
    studentPromo: 'All Apps from $19.99/mo (first year, 71% off)',
    pricing: {
      free: false,
      premiumSubscription: 'All Apps $69.99/mo (retail) · $19.99/mo student first year',
      oneTimePurchase: null,
      aiCredits: true,
      studentPrice: '$19.99/mo (first year), then $39.99/mo',
