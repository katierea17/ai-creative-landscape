...
export const competitors: Competitor[] = [
  ...
  },
  {
    ...
    studentMessaging: 'The apps that power creative careers. Students and teachers save over 60% on Creative Cloud All Apps — Photoshop, Premiere Pro, Illustrator, and 20+ more. Master the tools that employers expect.',
    studentPromo: 'All Apps from $19.99/mo (first year, 60%+ off)',
    pricing: {
      free: false,
      premiumSubscription: 'All Apps $59.99/mo (retail) · $19.99/mo student first year',
      oneTimePurchase: null,
      aiCredits: true,
      studentPrice: '$19.99/mo (first year), then $35.99/mo',
      studentPromo: '60%+ off for verified students and teachers',
    ...
    aiFeatures: {
      ...
      creativeEditing: 'Generative Fill, Generative Expand, Remove tool, AI video editing in Premiere',
      imageGeneration: 'Firefly (licensed-content trained, commercially safe)',
      videoGeneration: 'Generative Extend, AI B-roll, auto-assembly in Premiere via creative agent',
    },
    experience: {
      easeOfUse: 'Medium',
      certification: 'Adobe Certified Professional (exam-based, industry-recognized)',
      frictionRating: 'Medium',
      onboarding: 'App-by-app onboarding; steep learning curve offset by extensive tutorials, Adobe Express as entry point',
    },
    sentiment: {
      score: 8,
      trend: 'Up',
      praised: ['Industry-standard tools', 'Firefly safe for commercial use', 'Creative agent reduces production complexity'],
      complaints: ['Too expensive for AI features (Q9)', 'Steeper learning curve than Canva or CapCut'],
    },
  },
  {
    id: 'canva',
