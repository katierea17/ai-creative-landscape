...
const COMPETITORS = [
  ...
  },
  {
    id: 'chatgpt',
    name: 'ChatGPT (OpenAI)',
    pricing: 'Free (with ads, US). Go: $8/mo. Plus: $20/mo. Pro: $200/mo.',
    notable: 'Go tier at $8/mo launched globally Jan 2026; GPT-5.5 Apr 2026; interactive charts Jun 2026',
    studentPromo: null,
  ...
  },
  {
    id: 'gemini',
    name: 'Gemini (Google)',
    pricing: 'AI Plus: $4.99/mo (cut Jun 9, 2026, 400GB storage). AI Pro: $19.99/mo. AI Ultra: $99.99/mo. Students: 50% off AI Pro ($9.99/mo).',
    notable: 'AI Plus cut to $4.99/mo Jun 9, 2026 — now cheapest paid AI sub in US. Gemini Spark (24/7 agent), Gemini Omni (video gen), Gemini 3.5 Flash launched.',
    studentPromo: '50% off AI Pro for students ($9.99/mo)',
  ...
  },
  {
    id: 'final-cut-pro',
    name: 'Final Cut Pro',
    pricing: 'Apple Creator Studio: $12.99/mo or $129/yr (FCP + Logic Pro + Pixelmator Pro + more). One-time: $299.99. Students: $2.99/mo via Creator Studio.',
    notable: 'Apple Creator Studio bundle launched Jan 28, 2026 at $12.99/mo; new AI features: Visual Search, Beat Detection, Transcript Search',
